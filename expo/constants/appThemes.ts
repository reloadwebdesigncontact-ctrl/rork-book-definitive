...
export const APP_THEMES: Record<AppTheme, ColorPalette> = {
  ...
  neon: {
    ...
    icon: 'https://raw.githubusercontent.com/reloadwebdesigncontact-ctrl/rork-book-definitive/main/expo/assets/images/neon.png',
  },
  flamingo: {
    primary: '#FF3D8B',
    secondary: '#FF6B6B',
    ...
    icon: 'https://raw.githubusercontent.com/reloadwebdesigncontact-ctrl/rork-book-definitive/main/expo/assets/images/flamingo.png',
  },
  aurora: {
    primary: '#FFA500',
    secondary: '#E879A0',
    ...
    icon: 'https://raw.githubusercontent.com/reloadwebdesigncontact-ctrl/rork-book-definitive/main/expo/assets/images/aurora.png',
  },
  ocean: {
    primary: '#0EA5E9',
    secondary: '#06B6D4',
    ...
    icon: 'https://raw.githubusercontent.com/reloadwebdesigncontact-ctrl/rork-book-definitive/main/expo/assets/images/ocean.png',
  },
};
